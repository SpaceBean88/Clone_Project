    ...
    <div class="wrap_DT_body">
        ...
        <div class="dt_Top_Wrap ">
            <div class="dt_Ttop">
                ...
                <div class="dt_Name">
                    <h1><span id="IDGoodsName"> 아기돼지 삼제 </span>
                    </h1>
                    <dl class="dt_Name_info">
                        <dd class="etc">뮤지컬<span> |</span> 50분 <span>|</span> 24개월이상 관람가능</dd>
                    </dl>
                </div>
                    ...
                    <div class="crossbr">
                                ...
                                <div class="TabA_Info">
                                    ...
                                    <ul class="info_Lst">
                                        ...
                                        <li class="item">
                                            <dl>
                                                <dt>장소</dt>
                                                <dd><span>대학로 명작극장 1관</span></dd>
                                            </dl>
                                        </li>
                                        <li class="item">
                                            <dl>
                                                <dt>기간</dt>
                                                <dd><span>2019.09.14 ~ 2019.12.29</span>
                                                </dd>
                                            </dl>
                                        </li>
                                        <li class="item">
                        ...
                        <div class="DT_Rarea">
                            ...
                            <div class="Date_tit">
                                ...
                                <p class="time"><span class="ff_tahoma fs_s11">2019.12.21 ~ 2019.12.28</span></p>
                            </div>

                            <div class="tk_dt_btn_TArea">
                                <a href="#" onclick="" class="btn_rev"><span>예매하기</span></a>
        ...
        <div class="dt_Mid_L">
            <div class="Mid_Tab">
                ...
                <ul>
                    ...
                    <li id="ctrlTab2" name="ctrlTab" class=""><a href="">관람후기<span id="">(20)</span></a></li>

                    <li id="ctrlTab" name="ctrlTab" class=""><a href="">Q&A<span id=""></span></a></li>
                    ...
                    <div class="Data_infoarea">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_goods_info">
                            ...
                            <tr>
                                ...
                                <td colspan="3">2018.12.31 ~ 201.03.21 &nbsp;
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <ul class="list_option">
                                        ...
                                        <li>취소일자에 따라서 아래와 같이 취소수수료가 부과됩니다. 예매일 기준보다 관람일 기준이 우선 적용됩니다.<br />단, 예매 당일 밤 12시 이전 취소 시에는 취소수수료가 없으며, 예매수수료도 환불됩니다.(취소기한 내에 한함)</li>
